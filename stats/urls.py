...
urlpatterns = [
    ...
    url(r'^all_team_statistics/$', views.all_team_stats, name='all_team_stats'),
    url(r'^box_score/$', views.box_score, name='box_score'),
    url(r'^view_standing/(?P<season>[0-9-]+)$', views.standing, name='standing'),
    ...
    url(r'^view_team_comparisons/$', views.team_comparisons, name='team_comparisons'),
]
